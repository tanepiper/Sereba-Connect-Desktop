...
}});if(!D){A.load(new air.URLRequest("app:/assets/html/Popup.html"))}};Serebra.Chrome.Settings=function(){this.windowLoaded=function(H){var F=H.target.window.nativeWindow;
...
}});if(!C){A.load(new air.URLRequest("app:/assets/html/OptionsWindow.html"))}};