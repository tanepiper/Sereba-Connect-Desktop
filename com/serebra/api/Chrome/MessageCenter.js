					...
					var output = [];
						...
						output.push('<div id="inner-table-wrapper">');
  						...
  						function removeRow(id) {
  						  ...
  						  jQuery('tr#' + id, messageDom).css({'background-color':'#f00'});
							...
							jQuery('#message-table .delete', messageDom).bind('click.delete', function(){
							  ...
							  var confirmDelete = confirm("Are you sure you wish to delete this message?");
							  if (confirmDelete) {
						  ...
						  jQuery('#delete-all', messageDom).bind('click.deleteall', function(){
						    var confirmDelete = confirm("Are you sure you wish to delete all messages?");
							  if (confirmDelete) {
  							  var allMessages = Serebra.Database.Query({
